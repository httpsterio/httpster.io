...
<figure class="mb-xl">
  <img src="umami fork.webp" alt="Screenshot of Github's UI with the fork-button hilighted" title="Screenshot of Github's UI with the fork-button hilighted" />
...
<figure class="mb-xl">
  <img src="vercel main.webp" alt="Screenshot of Vercel's UI with user's name in the top nav hilighted" title="Screenshot of Vercel's UI with user's name in the top nav hilighted" />
...
<figure class="mb-xl">
  <img src="vercel storage.webp" alt="Screenshot of Vercel's UI with the navigation item storage hilighted and Create button for Postgres hilighted" title="Screenshot of Vercel's UI with the navigation item storage hilighted and Create button for Postgres hilighted" />
...
<figure class="mb-xl">
  <img src="vercel database settings.webp" alt="Screenshot of Vercel's UI with an example configuration for the database name and region" title="Screenshot of Vercel's UI with an example configuration for the database name and region" />
...
<figure class="mb-xl">
  <img src="database secrets.webp" alt="Screenshot of Vercel's UI with the database secrets" title="Screenshot of Vercel's UI with the database secrets" />
...
<figure class="mb-xl">
  <img src="github new file.webp" alt="Screenshot of GitHub's UI for creating a new file" title="Screenshot of GitHub's UI for creating a new file" />
